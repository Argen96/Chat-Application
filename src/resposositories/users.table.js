...
async function getAllPeopleUserHaveChattedFromDb(recipientUserIds) {
...
export { insertDataSignUp, verifyDataLogIn, verifyEmailForgotPassword, updatePassword, insertDataSignUpGoogle, allUsers, selectiveUsers, getAllPeopleUserHaveChattedFromDb }